...
const getNumberOfLines = () => {
    while (true) {
        ...
        if (isNaN(numberOfLines) || numberOfLines <= 0 || numberOfLines > 3) {
            console.log("Invalid input, please pick from 1-3 only!");
        } else {
...
const getBetAmount = (balance, lines) => {
    while (true) {
        ...
        if (isNaN(numberBet) || numberBet <= 0 || numberBet > balance / lines) {
            console.log("Invalid bet amount, please check balance and try again!");
        } else {
            return numberBet;
        }
    }
...
const game = () => {
    ...
    while (true) {
        ...
        if(balance <=0){
            console.log("Out of funds, please deposit");
            break;
